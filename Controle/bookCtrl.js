import Livro from "../Modelo/book.js";
...
export default class LivroCtrl {
    ...
    gravar(requisicao, resposta) {
        ...
        if (requisicao.method === 'POST' && requisicao.is('application/json')) {
            ...
            if (titulo && preco > 0 && dataPublicacao && autor) {
                const livro = new Livro(0,titulo, preco, dataPublicacao, autorId,autor);
                //resolver a promise
                livro.gravar().then(() => {
    ...
    atualizar(requisicao, resposta) {
        ...
        if ((requisicao.method === 'PUT' || requisicao.method === 'PATCH') && requisicao.is('application/json')) {
            ...
            if (codigo && titulo && preco > 0 && dataPublicacao && autor) {
                const livro = new Livro(codigo, titulo, preco, dataPublicacao, autor);
                //resolver a promise
